...
public interface IUniqueID {
     ...
     * A value of {@link net.minecraftforge.oredict.OreDictionary#WILDCARD_VALUE} may indicate the unique ID represents
     * a class of blocks or items.
     */
    int getMeta();

    /**
     * Gets the Forge {@link cpw.mods.fml.common.registry.GameRegistry.UniqueIdentifier} representation of the unique
     * ID, which doesn't carry the mod ID.
     */
