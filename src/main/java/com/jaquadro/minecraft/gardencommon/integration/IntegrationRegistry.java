...
public class IntegrationRegistry {
    ...
    static {
        ...
        if (Loader.isModLoaded("AgriCraft")) reg.add(new AgriCraft());
        if (Loader.isModLoaded("BiomesOPlenty")) reg.add(new BiomesOPlenty());
        if (Loader.isModLoaded("Botania")) reg.add(new Botania());
    }
