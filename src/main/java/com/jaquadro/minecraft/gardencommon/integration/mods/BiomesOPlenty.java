...
public class BiomesOPlenty extends IntegrationModule {
    ...
    public void init() throws Throwable {
        ...
        plantReg.registerPlantInfo(MOD_ID, "plants", 7, new SimplePlantInfo(PlantType.GROUND, PlantSize.FULL, 1, 2)); // Cattail
                                                                                                                      // Stage
                                                                                                                      // 1
                                                                                                                      // (cattail)
        ...
        plantReg.registerPlantInfo(
            ...
            "plants",
            10,
            new SimplePlantInfo(PlantType.GROUND, PlantSize.FULL, 2, 2, new int[] { 10, 9 })); // Cattail Stage 2
                                                                                               // (cattalbottom)
        plantReg.registerPlantInfo(MOD_ID, "plants", 11, new SimplePlantInfo(PlantType.GROUND, PlantSize.FULL)); // Wild
                                                                                                                 // carrot
        ...
        plantReg.registerPlantInfo(
            ...
            "plants",
            14,
            new SimplePlantInfo(PlantType.AQUATIC_EMERGENT, PlantSize.FULL, 2, 2)); // Reed
        ...
        plantReg.registerPlantInfo(
            ...
            "foliage",
            3,
            new SimplePlantInfo(PlantType.GROUND, PlantSize.LARGE, 2, 2, new int[] { 3, 6 })); // hedgebottom
        ...
        plantReg
            .registerPlantInfo(MOD_ID, "flowers", 10, new SimplePlantInfo(PlantType.AQUATIC_SURFACE, PlantSize.SMALL)); // lilyflower
        plantReg.registerPlantInfo(
            MOD_ID,
            "flowers",
            13,
            new SimplePlantInfo(PlantType.GROUND, PlantSize.MEDIUM, 2, 2, new int[] { 13, 14 })); // eyebulbbottom
        ...
        plantReg.registerPlantInfo(
            ...
            "coral1",
            8,
            new SimplePlantInfo(PlantType.AQUATIC, PlantSize.LARGE, 2, 2, new int[] { 8, 10 })); // kelpbottom
        ...
        plantReg
            .registerPlantInfo(MOD_ID, "stoneFormations", 0, new SimplePlantInfo(PlantType.GROUND, PlantSize.LARGE)); // atalagmite
        plantReg
            .registerPlantInfo(MOD_ID, "stoneFormations", 1, new SimplePlantInfo(PlantType.HANGING, PlantSize.LARGE)); // stalacmite
    ...
    private static class BOPMetaResolver implements IPlantMetaResolver {
        ...
        public int getPlantSectionMeta(Block block, int meta, int section) {
            GameRegistry.UniqueIdentifier uid = GameRegistry.findUniqueIdentifierFor(block);
            if (uid.name.equals("foliage")) {
                if (meta == 3) return (section == 1) ? 3 : 6;
            }
    ...
    public static class BOPShrubRenderer implements IPlantRenderer {
