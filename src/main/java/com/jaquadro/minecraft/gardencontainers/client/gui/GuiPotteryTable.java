...
public class GuiPotteryTable extends GuiContainer {
    ...
    protected void drawGuiContainerForegroundLayer(int p_146979_1_, int p_146979_2_) {
        String name = tilePotteryTable.hasCustomInventoryName() ? tilePotteryTable.getInventoryName()
            : I18n.format(tilePotteryTable.getInventoryName(), new Object[0]);
        ...
        for (int i = start; i < end; i++) {
            ...
            if (slot != null && slot.getStack() != null) {
                ...
                if (item.getItem() == ModItems.potteryPattern) {
                    ...
                    if (pattern != null) drawTexturedModelRectFromIcon(
