...
public class LargePotRenderer implements ISimpleBlockRenderingHandler {
    ...
    public void renderInventoryBlock(Block block, int metadata, int modelId, RenderBlocks renderer) {
        if (!(block instanceof BlockLargePot)) return;
    ...
    public boolean renderWorldBlock(IBlockAccess world, int x, int y, int z, Block block, int modelId,
        ...
        if (!(block instanceof BlockLargePot)) return false;
    ...
    private boolean renderWorldBlockPass1(IBlockAccess world, int x, int y, int z, BlockLargePot block, int modelId,
        ...
        if (icon != null) {
            ...
            if (connectFlags != (ModularBoxRenderer.CONNECT_XNEG | ModularBoxRenderer.CONNECT_XPOS
                | ModularBoxRenderer.CONNECT_ZNEG
        ...
        if (!didRender) RenderHelper.instance.renderEmptyPlane(x, y, z);
