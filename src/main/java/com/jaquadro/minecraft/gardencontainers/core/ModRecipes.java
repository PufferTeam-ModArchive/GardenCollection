...
public class ModRecipes {
    ...
    private static String[] dyeOreDict = { "dyeBlack", "dyeRed", "dyeGreen", "dyeBrown", "dyeBlue", "dyePurple",
        "dyeCyan", "dyeLightGray", "dyeGray", "dyePink", "dyeLime", "dyeYellow", "dyeLightBlue", "dyeMagenta",
        "dyeOrange", "dyeWhite", };

    public void init() {
        GameRegistry.addRecipe(new ItemStack(ModBlocks.largePot, 3, 1), "x x", "x x", "xxx", 'x', Blocks.clay);
        GameRegistry.addRecipe(new ItemStack(ModBlocks.largePot, 3), "x x", "x x", "xxx", 'x', Blocks.hardened_clay);
        ...
        GameRegistry.addRecipe(new ItemStack(ModBlocks.mediumPot, 3), "x x", "x x", " x ", 'x', Blocks.hardened_clay);
        ...
        for (int i = 1; i < 256; i++) {
            if (GardenContainers.config.hasPattern(i)) GameRegistry.addSmelting(
