...
public class BasicConnectionProfile implements IConnectionProfile {
    ...
    public boolean isAttachedNeighbor(IBlockAccess blockAccess, int x, int y, int z, int side) {
        switch (side) {
            case 0:
                return isAttachedNeighbor(blockAccess, x, y, z, x, y - 1, z);
            case 1:
                return isAttachedNeighbor(blockAccess, x, y, z, x, y + 1, z);
            case 2:
                return isAttachedNeighbor(blockAccess, x, y, z, x, y, z - 1);
            case 3:
                return isAttachedNeighbor(blockAccess, x, y, z, x, y, z + 1);
            case 4:
                return isAttachedNeighbor(blockAccess, x, y, z, x - 1, y, z);
            case 5:
                return isAttachedNeighbor(blockAccess, x, y, z, x + 1, y, z);
        }
    ...
    public boolean isAttachedNeighbor(IBlockAccess blockAccess, int x, int y, int z, int nx, int ny, int nz) {
         ...
         * return false;
         * if (substrate != null) {
         * if (substrate.getItem() != nGarden.substrate.getItem() || substrate.getItemDamage() !=
         * nGarden.substrate.getItemDamage())
         * return false;
         * }
         */
