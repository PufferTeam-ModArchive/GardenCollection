...
public class Slot14ProfileBounded extends Slot14Profile {
    ...
    private AxisAlignedBB[] bound = new AxisAlignedBB[] { AxisAlignedBB.getBoundingBox(0, 0, 0, 1, 1, 1) };
    private AxisAlignedBB[] boundS = new AxisAlignedBB[] { AxisAlignedBB.getBoundingBox(0, 0, 0, 1, 0.0625, 1 - 0.3125),
        AxisAlignedBB.getBoundingBox(0, 0.0625, 0, 1, 0.125, 1 - 0.25),
        AxisAlignedBB.getBoundingBox(0, 0.125, 0, 1, 1, 1 - 0.1875) };
    private AxisAlignedBB[] boundN = new AxisAlignedBB[] { AxisAlignedBB.getBoundingBox(0, 0, 0.3125, 1, 0.0625, 1),
        AxisAlignedBB.getBoundingBox(0, 0.0625, 0.25, 1, 0.125, 1),
        AxisAlignedBB.getBoundingBox(0, 0.125, 0.1875, 1, 1, 1) };
    private AxisAlignedBB[] boundE = new AxisAlignedBB[] { AxisAlignedBB.getBoundingBox(0, 0, 0, 1 - 0.3125, 0.0625, 1),
        AxisAlignedBB.getBoundingBox(0, 0.0625, 0, 1 - 0.25, 0.125, 1),
        AxisAlignedBB.getBoundingBox(0, 0.125, 0, 1 - 0.1875, 1, 1) };
    private AxisAlignedBB[] boundW = new AxisAlignedBB[] { AxisAlignedBB.getBoundingBox(0.3125, 0, 0, 1, 0.0625, 1),
        ...
        switch (slot) {
            case SLOT_NW:
                ...
                if (connection.isAttachedNeighbor(blockAccess, x, y, z, x - 1, y, z - 1)) {
                    ...
                    if (connectedN && connectedW) activeBound = bound;
                    else if (connectedN) activeBound = boundN;
                    else if (connectedW) activeBound = boundW;
                } else if (connection.isAttachedNeighbor(blockAccess, x, y, z, x, y, z - 1)) activeBound = boundW;
                else if (connection.isAttachedNeighbor(blockAccess, x, y, z, x - 1, y, z)) activeBound = boundN;
                break;
            ...
            case SLOT_NE:
                ...
                if (connection.isAttachedNeighbor(blockAccess, x, y, z, x + 1, y, z - 1)) {
                    ...
                    if (connectedN && connectedE) activeBound = bound;
                    else if (connectedN) activeBound = boundN;
                    else if (connectedE) activeBound = boundE;
                } else if (connection.isAttachedNeighbor(blockAccess, x, y, z, x, y, z - 1)) activeBound = boundE;
                else if (connection.isAttachedNeighbor(blockAccess, x, y, z, x + 1, y, z)) activeBound = boundN;
                break;
            ...
            case SLOT_SW:
                ...
                if (connection.isAttachedNeighbor(blockAccess, x, y, z, x - 1, y, z + 1)) {
                    ...
                    boolean connectedW = connection.isAttachedNeighbor(blockAccess, x, y, z, x - 1, y, z);
                    if (connectedS && connectedW) activeBound = bound;
                    else if (connectedS) activeBound = boundS;
                    else if (connectedW) activeBound = boundW;
                } else if (connection.isAttachedNeighbor(blockAccess, x, y, z, x, y, z + 1)) activeBound = boundW;
                else if (connection.isAttachedNeighbor(blockAccess, x, y, z, x - 1, y, z)) activeBound = boundS;
                break;
            ...
            case SLOT_SE:
                ...
                if (connection.isAttachedNeighbor(blockAccess, x, y, z, x + 1, y, z + 1)) {
                    boolean connectedS = connection.isAttachedNeighbor(blockAccess, x, y, z, x, y, z + 1);
                    boolean connectedE = connection.isAttachedNeighbor(blockAccess, x, y, z, x + 1, y, z);
                    if (connectedS && connectedE) activeBound = bound;
                    else if (connectedS) activeBound = boundS;
                    else if (connectedE) activeBound = boundE;
                } else if (connection.isAttachedNeighbor(blockAccess, x, y, z, x, y, z + 1)) activeBound = boundE;
                else if (connection.isAttachedNeighbor(blockAccess, x, y, z, x + 1, y, z)) activeBound = boundS;
