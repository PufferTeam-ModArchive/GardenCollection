...
public class GuiGardenLayout extends GuiContainer {
    ...
    public void drawScreen(int mouseX, int mouseY, float dt) {
        ...
        for (int i = 0, n = inventorySlots.inventorySlots.size(); i < n; i++) {
            ...
            if (func_146978_c(slot.xDisplayPosition, slot.yDisplayPosition, 16, 16, mouseX, mouseY)) hoveredSlot = slot;
        }
    ...
    protected void drawGuiContainerForegroundLayer(int p_146979_1_, int p_146979_2_) {
        ...
        String name = tileGarden.hasCustomInventoryName() ? tileGarden.getInventoryName()
            : I18n.format(tileGarden.getInventoryName(), new Object[0]);
    ...
    protected void drawSlotHighlight(Slot slot) {
        if (hoveredSlot == null || isInPlayerInventory(hoveredSlot) || slot == hoveredSlot) return;
