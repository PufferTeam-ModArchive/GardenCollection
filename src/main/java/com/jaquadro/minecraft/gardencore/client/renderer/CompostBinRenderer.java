...
public class CompostBinRenderer implements ISimpleBlockRenderingHandler {
    ...
    public void renderInventoryBlock(Block block, int metadata, int modelId, RenderBlocks renderer) {
        if (!(block instanceof BlockCompostBin)) return;
    ...
    private void renderInventoryBlock(BlockCompostBin block, int metadata, int modelId, RenderBlocks renderer) {
        ...
        boxRenderer.renderInterior(
            ...
            1,
            0,
            ModularBoxRenderer.CUT_ZNEG | ModularBoxRenderer.CUT_ZPOS);
        boxRenderer.renderInterior(
            null,
            block,
            0,
        ...
        boxRenderer.renderInterior(
            ...
            .875,
            0,
            ModularBoxRenderer.CUT_XNEG | ModularBoxRenderer.CUT_XPOS);
        boxRenderer.renderInterior(
            null,
            block,
            0,
    ...
    public boolean renderWorldBlock(IBlockAccess world, int x, int y, int z, Block block, int modelId,
        ...
        if (!(block instanceof BlockCompostBin)) return false;
