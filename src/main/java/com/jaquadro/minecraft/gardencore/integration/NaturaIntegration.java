...
public class NaturaIntegration {
    ...
    private static void initWood() {
        ...
        Block leafNoColor = GameRegistry.findBlock(MOD_ID, "floraleavesnocolor"); // NLeavesNocolor (sakura, ghostwood,
                                                                                  // bloodwood, willow)
        Block leafDark = GameRegistry.findBlock(MOD_ID, "Dark Leaves"); // NLeavesDark (darkwood, darkwood_flower,
                                                                        // darkwood_fruit, fusewood)
        Block leafOverworld = GameRegistry.findBlock(MOD_ID, "Rare Leaves"); // OverworldLeaves (maple, silverbell,
                                                                             // purpleheart, tiger)
