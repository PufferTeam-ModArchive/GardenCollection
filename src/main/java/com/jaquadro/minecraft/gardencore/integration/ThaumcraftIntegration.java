...
public class ThaumcraftIntegration {
    ...
    public static void init() {
        ...
        plantReg
            .registerPlantInfo(MOD_ID, "blockCustomPlant", 2, new SimplePlantInfo(PlantType.GROUND, PlantSize.SMALL));
        plantReg
            .registerPlantInfo(MOD_ID, "blockCustomPlant", 4, new SimplePlantInfo(PlantType.INVALID, PlantSize.LARGE));
    }
