...
public class ContainerCompostBin extends Container {
    ...
    public void updateProgressBar(int id, int value) {
        if (id == 0) tileCompost.binDecomposeTime = value;
        if (id == 1) tileCompost.currentItemDecomposeTime = value;
        if (id == 2) tileCompost.itemDecomposeCount = value;
    }
