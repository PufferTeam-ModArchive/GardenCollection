...
public class ItemTrowel extends Item {
    ...
    public boolean onItemUse(ItemStack itemStack, EntityPlayer player, World world, int x, int y, int z, int side,
        ...
        if (block instanceof BlockGarden) {
            ...
            if (te != null) {
                player
                    .openGui(GardenCore.instance, GuiHandler.gardenLayoutGuiID, world, te.xCoord, te.yCoord, te.zCoord);
                return true;
            }
        }
         ...
         * world.playSoundEffect( + .5f, y + .5f, z + .5f, stepSound.getStepResourcePath(), (stepSound.getVolume() +
         * .5f) / 2, stepSound.getPitch() * .8f);
         * if (!world.isRemote) {
