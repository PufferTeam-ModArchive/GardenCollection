...
public class BlockBloomeryFurnace extends BlockContainer {
    ...
    public void onBlockAdded(World world, int x, int y, int z) {
        ...
        if (!world.isRemote) {
            ...
            if (neighborZP.func_149730_j() && !neighborZN.func_149730_j()) direction = 3;
            if (neighborZN.func_149730_j() && !neighborZP.func_149730_j()) direction = 2;
            if (neighborXP.func_149730_j() && !neighborXN.func_149730_j()) direction = 5;
            if (neighborXN.func_149730_j() && !neighborXP.func_149730_j()) direction = 4;
    ...
    public IIcon getIcon(int side, int meta) {
        ...
        if (metaDir == 0) metaDir = 3;

        if (metaDir == side) return (lit) ? iconFrontLit : blockIcon;
    ...
    public boolean onBlockActivated(World world, int x, int y, int z, EntityPlayer player, int side, float hitX,
        ...
        if (tile != null) player.openGui(GardenStuff.instance, GuiHandler.bloomeryFurnaceGuiID, world, x, y, z);
