...
public class BlockCandelabra extends BlockContainer {
    ...
    public void onBlockPlacedBy(World world, int x, int y, int z, EntityLivingBase entity, ItemStack itemStack) {
        ...
        if (te == null || te.isDirectionInitialized()) return;
        ...
        if (tile.isSconce()) {
            if (level == 0) {
                RenderHelper.instance.state
                    .transformCoord(.5f, flameDepth, .25f, c, RenderHelperState.ROTATION_BY_FACE_FACE[2][dir]);
                renderParticleAt(world, x + c[0], y + c[1], z + c[2]);
            }
            if (level == 1 || level == 2) {
                RenderHelper.instance.state
                    .transformCoord(.25f, flameDepth, .25f, c, RenderHelperState.ROTATION_BY_FACE_FACE[2][dir]);
                renderParticleAt(world, x + c[0], y + c[1], z + c[2]);
                RenderHelper.instance.state
                    .transformCoord(.75f, flameDepth, .25f, c, RenderHelperState.ROTATION_BY_FACE_FACE[2][dir]);
                renderParticleAt(world, x + c[0], y + c[1], z + c[2]);
            }
            if (level == 2) {
                RenderHelper.instance.state
                    .transformCoord(.5f, flameDepth, .375f, c, RenderHelperState.ROTATION_BY_FACE_FACE[2][dir]);
                renderParticleAt(world, x + c[0], y + c[1], z + c[2]);
            }
        } else {
            ...
            if (level >= 0 && !hanging) {
                RenderHelper.instance.state
                    .transformCoord(.5f, flameDepth + .0625f, .5f, c, RenderHelperState.ROTATION_BY_FACE_FACE[2][dir]);
                renderParticleAt(world, x + c[0], y + c[1], z + c[2]);
            }
            if (level >= 1) {
                RenderHelper.instance.state
                    .transformCoord(.15625f, flameDepth, .5f, c, RenderHelperState.ROTATION_BY_FACE_FACE[2][dir]);
                renderParticleAt(world, x + c[0], y + c[1], z + c[2]);
                RenderHelper.instance.state
                    .transformCoord(.84375, flameDepth, .5f, c, RenderHelperState.ROTATION_BY_FACE_FACE[2][dir]);
                renderParticleAt(world, x + c[0], y + c[1], z + c[2]);
            }
            if (level >= 2) {
                RenderHelper.instance.state
                    .transformCoord(.5f, flameDepth, .15625f, c, RenderHelperState.ROTATION_BY_FACE_FACE[2][dir]);
                renderParticleAt(world, x + c[0], y + c[1], z + c[2]);
                RenderHelper.instance.state
                    .transformCoord(.5f, flameDepth, .84375, c, RenderHelperState.ROTATION_BY_FACE_FACE[2][dir]);
                renderParticleAt(world, x + c[0], y + c[1], z + c[2]);
            }
        }
    }
