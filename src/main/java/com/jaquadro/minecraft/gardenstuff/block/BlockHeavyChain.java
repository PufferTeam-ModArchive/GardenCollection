...
public class BlockHeavyChain extends Block implements IChain {
    ...
    public void onNeighborBlockChange(World world, int x, int y, int z, Block block) {
        if (block == this || block == ModBlocks.lantern) world.notifyBlockOfNeighborChange(x, y + 1, z, this);

        if (world.getBlock(x, y + 1, z) != this) world.notifyBlockOfNeighborChange(x, y + 2, z, this);
    }
