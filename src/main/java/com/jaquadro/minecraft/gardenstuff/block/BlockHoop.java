...
public class BlockHoop extends Block implements IChainAttachable {
    ...
    private Vec3[] attachPoints = new Vec3[] { Vec3.createVectorHelper(.03125, .375f, .03125),
        Vec3.createVectorHelper(.03125, .375f, 1 - .03125), Vec3.createVectorHelper(1 - .03125, .375f, .03125),
        Vec3.createVectorHelper(1 - .03125, .375f, 1 - .03125), };

    @Override
    public Vec3[] getChainAttachPoints(int side) {
        if (side == 1) return attachPoints;
