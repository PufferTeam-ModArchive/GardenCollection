...
public class VanillaLanternSource {
    ...
    public static class TorchLanternSource extends StandardLanternSource {
        ...
        public void renderParticle(World world, int x, int y, int z, Random rand, int meta) {
            ...
            if (tile == null || !tile.hasGlass()) world.spawnParticle("smoke", px, py, pz, 0.0D, 0.0D, 0.0D);
    ...
    public static class RedstoneTorchSource extends StandardLanternSource implements IRedstoneSource {
        ...
        public void renderItem(RenderBlocks renderer, IItemRenderer.ItemRenderType renderType, int meta) {
            ...
            renderHelper.setRenderBounds(0, 0, 0.4375, 1, 1, 0.5625);
            renderHelper
                .renderFace(RenderHelper.ZNEG, null, Blocks.redstone_torch, Blocks.redstone_torch.getIcon(2, 0), meta);
            renderHelper
                .renderFace(RenderHelper.ZPOS, null, Blocks.redstone_torch, Blocks.redstone_torch.getIcon(3, 0), meta);
            renderHelper.setRenderBounds(0.4375, 0, 0, 0.5625, 1, 1);
            renderHelper
                .renderFace(RenderHelper.XNEG, null, Blocks.redstone_torch, Blocks.redstone_torch.getIcon(4, 0), meta);
            renderHelper
                .renderFace(RenderHelper.XPOS, null, Blocks.redstone_torch, Blocks.redstone_torch.getIcon(5, 0), meta);
            renderHelper.setRenderBounds(0.4375, 0, 0.4375, 0.5625, 0.625, 0.5625);
            renderHelper
                .renderFace(RenderHelper.YPOS, null, Blocks.redstone_torch, Blocks.redstone_torch.getIcon(1, 0), meta);
        }
