...
public class BloomeryFurnaceRecipeHandler extends TemplateRecipeHandler {
    ...
    public class SmeltingPair extends CachedRecipe {
        ...
        public List<PositionedStack> getIngredients() {
            return getCycledIngredients(
                ...
                Arrays.asList(new PositionedStack[] { ingred1, ingred2 }));
        }
        ...
        public PositionedStack getOtherStack() {
            return (BloomeryFurnaceRecipeHandler.afuels.get(
    ...
    public TemplateRecipeHandler newInstance() {
        if (afuels == null || afuels.isEmpty()) findFuels();
            ...
            if (NEIServerUtils.areStacksSameTypeCrafting(stack, ingredient)) {
                for (ItemStack secondaryStack : secondary) {
                    SmeltingPair arecipe = new SmeltingPair(
                        ...
                        new ItemStack(ModItems.wroughtIronIngot));
                    arecipe
                        .setIngredientPermutation(Arrays.asList(new PositionedStack[] { arecipe.ingred1 }), ingredient);
            ...
            if (NEIServerUtils.areStacksSameTypeCrafting(stack, ingredient)) {
                for (ItemStack primaryStack : primary) {
                    SmeltingPair arecipe = new SmeltingPair(
                        ...
                        new ItemStack(ModItems.wroughtIronIngot));
                    arecipe
                        .setIngredientPermutation(Arrays.asList(new PositionedStack[] { arecipe.ingred2 }), ingredient);
                    arecipes.add(arecipe);
                }
            }
        }
