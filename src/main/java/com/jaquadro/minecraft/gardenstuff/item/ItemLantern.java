...
public class ItemLantern extends ItemBlock {
    ...
    public void addInformation(ItemStack itemStack, EntityPlayer player, List list, boolean par4) {
        if (ModBlocks.lantern.isGlass(itemStack)) {
            String glassName = Blocks.stained_glass.getUnlocalizedName() + "."
        ...
        String contents = StatCollector.translateToLocal(ModBlocks.makeName("lanternSource")) + ": "
        ...
        else contents += StatCollector.translateToLocal(ModBlocks.makeName("lanternSource.none"));
    ...
    public ItemStack makeItemStack(int count, int meta, boolean hasGlass, String source, int sourceMeta) {
        ...
        if (hasGlass) tag.setBoolean("glass", true);
