...
public class LatticeRenderer implements ISimpleBlockRenderingHandler {
    ...
    public boolean renderWorldBlock(IBlockAccess world, int x, int y, int z, Block block, int modelId,
        ...
        if (!(block instanceof BlockLattice)) return false;
    ...
    public boolean renderWorldBlock(IBlockAccess world, int x, int y, int z, BlockLattice block, int modelId,
        ...
        if (yMin < U7) boxRenderer.renderSolidBox(world, block, x, y, z, U7, yMin, U7, U9, U7, U9);
        if (yMax > U9) boxRenderer.renderSolidBox(world, block, x, y, z, U7, U9, U7, U9, yMax, U9);

        float zMin = extZNeg ? UN4 : (connectZNeg ? 0 : U7);
        float zMax = extZPos ? U20 : (connectZPos ? 1 : U9);

        if (zMin < U7) boxRenderer.renderSolidBox(world, block, x, y, z, U7, U7, zMin, U9, U9, U7);
        if (zMax > U9) boxRenderer.renderSolidBox(world, block, x, y, z, U7, U7, U9, U9, U9, zMax);

        float xMin = extXNeg ? UN4 : (connectXNeg ? 0 : U7);
        float xMax = extXPos ? U20 : (connectXPos ? 1 : U9);

        if (xMin < U7) boxRenderer.renderSolidBox(world, block, x, y, z, xMin, U7, U7, U7, U9, U9);
        if (xMax > U9) boxRenderer.renderSolidBox(world, block, x, y, z, U9, U7, U7, xMax, U9, U9);
         ...
         * int cutX = ModularBoxRenderer.CUT_YNEG | ModularBoxRenderer.CUT_YPOS | ModularBoxRenderer.CUT_ZNEG |
         ...
         * int cutZ = ModularBoxRenderer.CUT_YNEG | ModularBoxRenderer.CUT_YPOS | ModularBoxRenderer.CUT_XNEG |
